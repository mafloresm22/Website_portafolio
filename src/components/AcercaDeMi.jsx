                ...
                {showModal && (
                    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4">
                        ...
                        <motion.div
                            ...
                            className="relative w-full max-w-5xl bg-white dark:bg-slate-900 rounded-[2.5rem] shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-800"
                        >
                            <AboutMeModal onClose={handleCloseModal} darkMode={darkMode} />
                        </motion.div>
                    </div>
                )}
            </AnimatePresence>
